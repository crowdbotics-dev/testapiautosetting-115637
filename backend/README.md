...
## Project Structure
    ...
    ├── testapiautosetting_115637  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115637`
...
2. Clone this repo and `cd testapiautosetting_115637`
